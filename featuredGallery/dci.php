...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!-- about-section -->
        <section class="about-section about-page pb-0" style="padding: 5px;">
            <div class="auto-container">
        ...
        <section class="contact-section centred" style="padding: 10px;">
            <div class="auto-container">
                <h1>Distress Capital Investment</h1>
                <img src="assets/images/investcat.jpeg" alt=""></figure>
        ...
        <section class="contact-section bg-color-2">
            <div class="auto-container">
                ...
                <img src="assets/images/investnew.jpeg" alt=""></figure>
